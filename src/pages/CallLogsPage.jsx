...
const sampleCallLogs = [
  { id: 1, phoneNumber: '+44- 651234123125', callReceivedAt: '2026-01-12 12:24:11.1236676+00', summary: 'Caller wanted to book an appointment.', transcript: 'Assistant: Hello how may I help...' },
  { id: 2, phoneNumber: '+44- 651234123125', callReceivedAt: '2026-01-12 12:24:11.1236676+00', summary: 'Caller wanted to book an appointment.', transcript: 'Assistant: Hello how may I help...' },
  { id: 3, phoneNumber: '+44- 651234123125', callReceivedAt: '2026-01-12 12:24:11.1236676+00', summary: 'Caller wanted to book an appointment.', transcript: 'Assistant: Hello how may I help...' },
  { id: 4, phoneNumber: '+44- 651234123125', callReceivedAt: '2026-01-12 12:24:11.1236676+00', summary: 'Caller wanted to book an appointment.', transcript: 'Assistant: Hello how may I help...' },
  { id: 5, phoneNumber: '+44- 651234123125', callReceivedAt: '2026-01-12 12:24:11.1236676+00', summary: 'Caller wanted to book an appointment.', transcript: 'Assistant: Hello how may I help...' },
  { id: 6, phoneNumber: '+44- 651234123125', callReceivedAt: '2026-01-12 12:24:11.1236676+00', summary: 'Caller wanted to book an appointment.', transcript: 'Assistant: Hello how may I help...' },
];
...
const CallLogsPage = () => {
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-semibold text-gray-900 mb-6">Call logs</h1>
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        {/* Table Header */}
        <div className="grid grid-cols-[40px_1fr_1fr_1fr_1fr_50px] gap-4 px-4 py-3 bg-gray-50 border-b border-gray-200">
          <div className="flex items-center">
            <input
              type="checkbox"
              checked={selectedCalls.length === sampleCallLogs.length}
          ...
          <div className="text-sm font-medium text-gray-600">Call Received at</div>
          <div className="text-sm font-medium text-gray-600">Summary</div>
          <div className="text-sm font-medium text-gray-600">Transcript</div>
          <div></div>
        </div>
        ...
        <div>
          {filteredCalls.map((call, index) => (
            <div
              key={call.id}
              className={`grid grid-cols-[40px_1fr_1fr_1fr_1fr_50px] gap-4 px-4 py-4 items-center relative ${
            ...
            >
              ...
              <div className="text-sm font-medium text-gray-900">{call.phoneNumber}</div>
              <div className="text-sm text-[#3C49F7]">{call.callReceivedAt}</div>
